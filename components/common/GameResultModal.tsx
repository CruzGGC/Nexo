...
import { formatRatingChange, type RankTier } from '@/lib/auth/rating-system'
...
export function GameResultModal({ 
  ...
  ratingInfo,
  matchStats,
  // gameType available in props but not currently used
  ...
  useEffect(() => {
    ...
    // Reset is handled in cleanup to avoid sync setState
  }, [isOpen, ratingInfo])
